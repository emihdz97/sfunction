...
from ast import ForLoop, SetArray, WhileLoop, DoWhileLoop, LoopComparator, ChangeVariable, Variable, SetVariable, Bool, ToString, ToFloat, ToInt, Program, Lines, Equal, GreaterEqual, LessEqual, NotEqual, Greater, LessThan, String, Integer, Char, Float, Mul, Div, Sum, Sub, Display, Mod, Pow
...
class Parser():
	def __init__(self):
		self.pg = ParserGenerator(
			...
			['FOR','IN','SET_FLOAT', 'VALUES_STRING', 'SET_ARRAY', 'DOWHILE', 'WHILE','VAR_NAME','SET_BOOL','SET_INT','SET_CHAR','SET_STRING','AND', 'TRUE', 'FALSE','TO-STRING','TO-FLOAT','TO-INT','TO-BOOL', 'IF','EQ', 'GE', 'LE','NE','GT','LT','CHAR','FLOAT','STRING','$end','OPEN_BRACKET', 'DISP', 'CLOSED_BRACKET', 'SUM', 'SUB','MUL','DIV','INT','POW','EQL','MOD'],
			precedence =[
				('left', ['SUM','SUB']),
				('left', ['DIV','MUL']),
				('left', ['MOD','POW']),
